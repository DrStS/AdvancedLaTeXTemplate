...
\listfiles
\documentclass [10pt, twoside, openright, a5paper, final %showtrims
]{memoir}
\overfullrule=20mm
%\trimFrame
%\isopage[12]
...
\usepackage{graphicx}
	\graphicspath{{input/fig/}{intro/fig/}{appendix/fig/}}%Set global search path
...
%% END TABULAR
%% START TITLE
\newcommand*{\PhDtitle}[1]{\def\PhDtitle{#1}}
\PhDtitle{Some PhD Title}
%% END TITLE
%\setlength{\parindent}{0mm}%no paragraph indentation
%% START define colors
\definecolor{shadecolor}{rgb}{0.7,0.8,0.9}
\definecolor{TUMblau}{HTML}{0065BD}
...
\colorbox{TUMblau}{\color{white}\bfseries\scshape\thechapter}%
}}%
\rotatebox{90}{%
\resizebox{%
...
\renewcommand\chaptitlefont{\normalfont\huge\bfseries\scshape\color{TUMblau}}
...
%% START HYPERREF
%Links
\usepackage[plainpages=false,pdfpagelabels,pdfview=Fit,pdftex]{hyperref} 
...
\hypersetup{   
	...
	pdfkeywords={Co-Simulation; N-Code Coupling; Multi-Code Coupling; Interface Jacobian; Partitioned Solution Strategy; Multiphysics; Fluid–Structure Interaction; Wind Turbine},         % list of keywords
